...
class PostCreate(forms.Form):
    ...
    image = forms.ImageField(required=False, widget=forms.ClearableFileInput(attrs={'class': 'add_posting_field'}))
    comments = forms.CharField(max_length=50, widget=forms.Textarea(attrs={'class': 'add_posting_field'}), required=False)
